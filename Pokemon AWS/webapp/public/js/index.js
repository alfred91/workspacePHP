...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (token) {
    fetch("http://3.211.131.204:3000/api/pokemon/list", {
      ...
      .then((pokemons) => {
        ...
        pokemons.forEach((pokemon) => {
          ...
          card.className = "card";
          card.innerHTML = `
            <img src="http://3.211.131.204:3000/images/${pokemon.imagen
            }" alt="${pokemon.nombre}">
    ...
    <button class="button" onclick="obtenerDetallesPokemon('${pokemon._id
            }');">Ver Detalles</button>
  </div>
          `;
...
<div class="div-translucent">
  ...
  <table class="table-auto w-full table-translucent">
        <tbody>
          <tr><td class="border px-4 py-2">Especie</td><td class="border px-4 py-2">${pokemon.especie
    }</td></tr>
          <tr><td class="border px-4 py-2">Tipo</td><td class="border px-4 py-2">${pokemon.tipo.join(
      ", "
    )}</td></tr>
          <tr><td class="border px-4 py-2">Altura</td><td class="border px-4 py-2">${pokemon.altura
    } metros</td></tr>
          <tr><td class="border px-4 py-2">Peso</td><td class="border px-4 py-2">${pokemon.peso
    } kg</td></tr>
          <tr><td class="border px-4 py-2">Vida</td><td class="border px-4 py-2">${pokemon.vida
    }</td></tr>
          <tr><td class="border px-4 py-2">Puntos de Salud en Juego</td><td class="border px-4 py-2">${pokemon.puntosSaludJuego
    }</td></tr>
          ${pokemon.preevolucion
