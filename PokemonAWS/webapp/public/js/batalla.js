...
document.addEventListener("DOMContentLoaded", async function () {
    try {
        ...
        pokemons.forEach((pokemon) => {
            ...
            option2.textContent = pokemon.nombre;const token = localStorage.getItem("token");
            ...
            function updatePokemonModal(pokemon, modalId) {
                ...
                modal.querySelector("img").src = `http://3.211.131.204:3000/images/${pokemon.imagen}`;
            ...
            async function atacarPokemon(pokemonAtacanteId, abilitiesContainerId, indexHabilidad, pokemonObjetivoId) {
                try {
                    ...
                    const attackResponse = await fetch(`http://3.211.131.204:3000/api/pokemon/${pokemonObjetivoId}/ataque/${puntosAtaque}`, {
                        method: 'PUT',
