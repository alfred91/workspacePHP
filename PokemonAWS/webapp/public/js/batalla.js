    ...
    try {
        ...
        pokemons.forEach((pokemon) => {
            ...
            async function loadAbilities(
                ...
                try {
                    const response = await fetch(
                        `http://3.211.131.204:3000/api/pokemon/id/${pokemonId}`,
                        {
                            headers: { Authorization: `Bearer ${token}` },
                        }
                    );
            ...
            function updatePokemonModal(pokemon, modalId) {
                ...
                modal.querySelector(
                    "img"
                ).src = `http://3.211.131.204:3000/images/${pokemon.imagen}`;
                ...
                modal.querySelector(
                    ".puntosSaludJuego"
                ).textContent = `Puntos de Salud en Juego: ${pokemon.puntosSaludJuego || "No disponible"
                    }`;
            }
            ...
            async function atacarPokemon(
                ...
                try {
                    ...
                    const attackResponse = await fetch(
                        `http://3.211.131.204:3000/api/pokemon/${pokemonObjetivoId}/ataque/${puntosAtaque}`,
                        {
                            method: "PUT",
                            headers: {
